...
reg = /(?<=\d\.\s+)\w+/gi; //look behind

str = "<h1>I am important</h1> <h1>so am i</h1>";
reg = /(?<=<h1>)[\w ]+(?=<\/h1>)/gi;

str = "23-06-1987 23-06-2087";
reg = /(\d{1,2})-(\d{1,2})-(\d{4})u/gi;
str = "b";
reg = /b|a*/i;

str =
  "https://platform-lookaside.fbsbx.com/platform/profilepic/?asid=2587783127908341&height=50&width=50&ext=1567457491&hash=AeTfqe87yyRq5wF8";
